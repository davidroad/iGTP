...
yaml_file=/rsrch5/home/gen_med_onc_rsch/khsieh/single_cell_pdx/code/igtp_eval_config.yaml
...
nohup python iGTP_eval.py --config $yaml_file > output_eval.log 2>&1 &
